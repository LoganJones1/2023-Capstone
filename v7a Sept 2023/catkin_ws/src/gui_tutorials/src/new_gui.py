...
from dynamixel_sdk_examples import *
...
def init_force():
    command = "roslaunch " +os.getcwd() +"/src/bota_driver/rokubimini_serial/launch/rokubimini_serial.launch"
...
class TutorialApp(MDApp):
    def __init__(self, **kwargs):
        ...
        self.screen=Builder.load_file('new_gui.kv') #load the .kv file for the main window
    ...
    # def send_position_callback(self, id, position, buttonid):
