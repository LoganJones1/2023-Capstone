...
if("TRUE" STREQUAL "TRUE")
  set(msf_core_SOURCE_PREFIX /home/robotis/catkin_ws/src/ethzasl_msf/msf_core)
  set(msf_core_DEVEL_PREFIX /home/robotis/catkin_ws/devel)
  set(msf_core_INSTALL_PREFIX "")
  set(msf_core_PREFIX ${msf_core_DEVEL_PREFIX})
else()
  set(msf_core_SOURCE_PREFIX "")
  set(msf_core_DEVEL_PREFIX "")
  set(msf_core_INSTALL_PREFIX /home/robotis/catkin_ws/install)
...
if(NOT "/home/robotis/catkin_ws/devel/include;/home/robotis/catkin_ws/src/ethzasl_msf/msf_core/include;/usr/include/eigen3 " STREQUAL " ")
  set(msf_core_INCLUDE_DIRS "")
  set(_include_dirs "/home/robotis/catkin_ws/devel/include;/home/robotis/catkin_ws/src/ethzasl_msf/msf_core/include;/usr/include/eigen3")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'msf_core' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robotis/catkin_ws/src/ethzasl_msf/msf_core/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(msf_core_EXPORTED_TARGETS ${${msf_core_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "/home/robotis/catkin_ws/src/ethzasl_msf/msf_core/cmake/export_flags.cmake")
