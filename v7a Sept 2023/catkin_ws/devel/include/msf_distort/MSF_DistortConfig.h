...
namespace msf_distort
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(MSF_DistortConfig &config, const MSF_DistortConfig &max, const MSF_DistortConfig &min) const override
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const MSF_DistortConfig &config1, const MSF_DistortConfig &config2) const override
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, MSF_DistortConfig &config) const override
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const MSF_DistortConfig &config) const override
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, MSF_DistortConfig &config) const override
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const MSF_DistortConfig &config) const override
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const MSF_DistortConfig &config, boost::any &val) const override
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, MSF_DistortConfig &top) const override
      {
        PT* config = boost::any_cast<PT*>(cfg);
...
//#line 42 "/home/robotis/catkin_ws/src/ethzasl_msf/msf_distort/cfg/MSF_Distort.cfg"
