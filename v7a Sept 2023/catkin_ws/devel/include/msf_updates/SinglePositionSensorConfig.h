...
namespace msf_updates
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(SinglePositionSensorConfig &config, const SinglePositionSensorConfig &max, const SinglePositionSensorConfig &min) const override
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const SinglePositionSensorConfig &config1, const SinglePositionSensorConfig &config2) const override
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, SinglePositionSensorConfig &config) const override
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const SinglePositionSensorConfig &config) const override
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, SinglePositionSensorConfig &config) const override
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const SinglePositionSensorConfig &config) const override
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const SinglePositionSensorConfig &config, boost::any &val) const override
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, SinglePositionSensorConfig &top) const override
      {
        PT* config = boost::any_cast<PT*>(cfg);
...
//#line 31 "/home/robotis/catkin_ws/src/ethzasl_msf/msf_updates/cfg/SinglePositionSensor.cfg"
      const int SinglePositionSensor_INIT_FILTER = 1;
//#line 32 "/home/robotis/catkin_ws/src/ethzasl_msf/msf_updates/cfg/SinglePositionSensor.cfg"
